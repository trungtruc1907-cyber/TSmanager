              ...
              {projects.filter(p => p.status === 'contract' || p.status === 'installation').map((project) => {
                ...
                return (
                  <motion.div 
                    ...
                    className="bg-white p-5 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-all space-y-4 relative overflow-hidden group cursor-pointer"
                  >
                    <div className="flex justify-between items-start">
                      <div className="space-y-1">
                        ...
                        <div className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter flex items-center gap-1">
                          ...
                          {customer?.address || 'Chưa xác định'}
                        </div>
                      </div>
                      <div className={cn("px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-wider flex items-center gap-1.5 shadow-sm border", status.color, status.color.replace('bg-', 'border-').replace('100', '200'))}>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-50/80 p-3 rounded-2xl border border-slate-100 flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-slate-400 font-black uppercase text-[8px] tracking-tighter">Hệ thống</p>
                      ...
                      <div className="bg-slate-50/80 p-3 rounded-2xl border border-slate-100 flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-slate-400 font-black uppercase text-[8px] tracking-tighter">Pin lưu trữ</p>
                          <p className="font-black text-xs text-slate-800 leading-none mt-0.5">{project.batterySizeKWh || 0} kWh</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-slate-50/80 p-3 rounded-2xl border border-slate-100 space-y-2">
                       <div className="flex items-center justify-between">
                          <p className="text-slate-400 font-black uppercase text-[8px] tracking-tighter">Tiến độ thi công</p>
                    ...
                    <div className="pt-2 flex items-center justify-between border-t border-slate-100">
                       <button 
                         ...
                         className="flex items-center gap-1 px-3 py-1.5 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white transition-all text-[10px] font-black uppercase tracking-wider border border-blue-100"
                       >
                          <TrendingUp className="h-3 w-3" /> Theo dõi tiến trình
                       </button>
              ...
              <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm space-y-4 flex-1">
                ...
                <div className="space-y-3.5 pt-1">
                  {salesLeaderboard.map((item, index) => (
                    <div key={`leaderboard-${item.id || index}-${index}`} className="flex items-center justify-between p-3 rounded-2xl bg-slate-50/50 hover:bg-slate-50 border border-slate-100/50 transition-colors">
                      <div className="flex items-center gap-3">
